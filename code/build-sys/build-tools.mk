...
CPPFLG_SYSINC	:= -isystem "$(call OS_SYN,$(call GET_SDCC_DIR)include/z80)" -isystem "$(call OS_SYN,$(call GET_SDCC_DIR)include)" -isystem "$(call OS_SYN,$(call GET_SDCC_DIR)..\include)"
