...
U 1 1 5E0B0114
P 6650 1600
F 0 "#PWR034" H 6650 1450 50  0001 C CNN
...
U 1 1 5E0B011A
P 6650 2100
F 0 "#PWR035" H 6650 1850 50  0001 C CNN
...
F 0 "C11" H 6765 1896 50  0000 L CNN
F 1 "0.1u" H 6765 1805 50  0000 L CNN
...
D[0..7]
$Comp
L z80-project:AT28C256-15PU U14
U 1 1 5DFEA428
P 7750 2700
F 0 "U14" H 7750 3715 50  0000 C CNN
F 1 "AT28C256-15PU" H 7750 3624 50  0000 C CNN
F 2 "Package_DIP:DIP-28_W15.24mm_Socket_LongPads" H 7750 2500 50  0001 C CNN
F 3 "http://www.farnell.com/datasheets/1626953.pdf?_ga=2.85835038.641070572.1576682455-1858140526.1572536997" H 7750 2500 50  0001 C CNN
	1    7750 2700
	1    0    0    -1  
$EndComp
Entry Wire Line
...
U 1 1 5E0296FC
P 5750 2500
F 0 "JP1" V 5796 2602 50  0000 L CNN
F 1 "Jumper_NC_Dual" V 5705 2602 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x03_P2.54mm_Vertical_SMD_Pin1Left" H 5750 2500 50  0001 C CNN
...
U 1 1 5E02CB98
P 5750 2100
AR Path="/5E02CB98" Ref="R?"  Part="1" 
AR Path="/5DFFC633/5E02CB98" Ref="R11"  Part="1" 
F 0 "R11" H 5680 2054 50  0000 R CNN
...
AR Path="/5DFFC633/5E0394E5" Ref="R9"  Part="1" 
...
U 1 1 5E02B9E8
P 4100 3700
F 0 "#PWR032" H 4100 3450 50  0001 C CNN
...
AR Path="/5DFFC633/5E02B23C" Ref="R10"  Part="1" 
F 0 "R10" H 3780 3654 50  0000 R CNN
...
U 1 1 5DFFD63C
P 2000 1450
F 0 "#PWR029" H 2000 1300 50  0001 C CNN
